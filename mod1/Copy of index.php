...
***************************************************************/
/**
 * Module 'Gruppanm Admin' for the 'grupptillh' extension.
 *
		...
		switch((string)$this->MOD_SETTINGS["function"])	{
			case 1:
				$content="<div align=center><strong>Hello World!</strong></div><br />
					The 'Kickstarter' has made this module automatically, it contains a default framework for a backend module but apart from it does nothing useful until you open the script '".substr(t3lib_extMgm::extPath("grupptillh"),strlen(PATH_site))."mod1/index.php' and edit it!
					<HR>
